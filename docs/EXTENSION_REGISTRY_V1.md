...
> Status: implementation contract retained in HHY v1.7.0; Registry v1 remains unchanged. This is an official-package trust model, not an open third-party publishing service.
