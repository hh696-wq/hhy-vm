<div align="center">
  ...
  **Pipe Everything.**
  ...
  [![Version](https://img.shields.io/badge/version-1.3.0-0969da)](VERSION)
...
当前版本是 **V1.3.0**（`1.3.0`），正式支持 macOS arm64、Linux arm64 和
...
```sh
tar -xzf hhy-1.3.0-PLATFORM-ARCH.tar.gz
cd hhy-1.3.0-PLATFORM-ARCH
./bin/hhy --version
...
V1.0 语言 contract 保持兼容；V1.3.0 正式提供 `hhy run --engine bytecode`、
