<div align="center">
  ...
  **Pipe Everything.**
  ...
  [![Version](https://img.shields.io/badge/version-1.3.1-0969da)](VERSION)
...
当前版本是 **V1.3.1**（`1.3.1`），正式支持 macOS arm64、Linux arm64 和
...
```sh
tar -xzf hhy-1.3.1-PLATFORM-ARCH.tar.gz
cd hhy-1.3.1-PLATFORM-ARCH
./bin/hhy --version
