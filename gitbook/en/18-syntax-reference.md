# 18. Complete Syntax Reference

V1.7.0 lexical rules, literals, operators, statements, closures, and module syntax.

## 18.1 Source files and lexical rules
...
## 18.2 Literals and native units
...
## 18.3 Operator precedence (highest to lowest)
...
## 18.4 Declarations, control flow, functions, and modules
