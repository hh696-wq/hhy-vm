# 16. Project: Multi-API Data Collector
...
## 16.1 One reliable collection flow

Built with HHY v1.7.0, this project collects two pages each from OpenAlex, Crossref, and GitHub. parallel(3) bounds concurrent HTTP downloads before heterogeneous JSON is normalized into one seven-column schema.
...
## 16.3 Run and incremental result
