# 12. Project: FlowGuard

Build a complete repository health and quality-gate application with HHY v1.7.0, including real fixtures, concurrent checks, JSON reports, and end-to-end tests.

## 12.1 More than a syntax demo

FlowGuard is a complete application run and self-tested with HHY v1.7.0. It accepts a project directory and JSON configuration, checks required files, scans files and possible credentials, runs quality commands and HTTP health checks concurrently, atomically writes a structured report, and uses a stable exit code to enforce the quality gate.
...
## 12.3 Run the complete self-test
...
## 12.4 Healthy and risky scenarios
...
## 12.5 Configure your own project
