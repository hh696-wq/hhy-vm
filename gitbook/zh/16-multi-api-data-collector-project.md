...
这个项目使用 HHY v1.7.0 同时采集 OpenAlex 学术成果、Crossref 论文元数据和 GitHub 仓库。每个来源请求 2 页，HTTP 下载由 parallel(3) 有界并发完成，异构 JSON 随后统一成 source、external_id、title、url、record_type、metric_name 和 metric_value。
