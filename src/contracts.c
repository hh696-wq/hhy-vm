...
static const HhyCallableContract contracts[] = {
    ...
    C("http.delete", 1, 2, HHY_EFFECT_NONE, false, false, true, false,
      "String, Map?", "HttpRequest", "main"),
    C("web.app", 0, 0, HHY_EFFECT_NONE, false, false, false, false,
      "()", "WebApp", "main"),
    C("web.get", 3, 3, HHY_EFFECT_NONE, false, false, false, false,
      "WebApp, String, Function(WebRequest -> WebResponse)", "WebApp", "main"),
    C("web.post", 3, 3, HHY_EFFECT_NONE, false, false, false, false,
      "WebApp, String, Function(WebRequest -> WebResponse)", "WebApp", "main"),
    C("web.put", 3, 3, HHY_EFFECT_NONE, false, false, false, false,
      "WebApp, String, Function(WebRequest -> WebResponse)", "WebApp", "main"),
    C("web.patch", 3, 3, HHY_EFFECT_NONE, false, false, false, false,
      "WebApp, String, Function(WebRequest -> WebResponse)", "WebApp", "main"),
    C("web.delete", 3, 3, HHY_EFFECT_NONE, false, false, false, false,
      "WebApp, String, Function(WebRequest -> WebResponse)", "WebApp", "main"),
    C("web.use", 2, 2, HHY_EFFECT_NONE, false, false, false, false,
      "WebApp, Function(WebRequest -> WebResponse | Null)", "WebApp", "main"),
    C("web.static", 3, 3, HHY_EFFECT_FILESYSTEM, false, true, false, false,
      "WebApp, String, Path", "WebApp", "main"),
    C("web.cors", 1, 2, HHY_EFFECT_NONE, false, false, false, false,
      "WebApp, Map?", "WebApp", "main"),
    C("web.request_id", 1, 1, HHY_EFFECT_NONE, false, false, false, false,
      "WebApp", "WebApp", "main"),
    C("web.health", 1, 2, HHY_EFFECT_NONE, false, false, false, false,
      "WebApp, String?", "WebApp", "main"),
    C("web.trust_proxy", 1, 1, HHY_EFFECT_NONE, false, false, false, false,
      "WebApp", "WebApp", "main"),
    C("web.text", 1, 2, HHY_EFFECT_NONE, false, false, false, false,
      "String, Map?", "WebResponse", "main"),
    C("web.html", 1, 2, HHY_EFFECT_NONE, false, false, false, false,
      "String, Map?", "WebResponse", "main"),
    C("web.json", 1, 2, HHY_EFFECT_NONE, false, true, false, false,
      "JsonValue, Map?", "WebResponse", "main"),
    C("web.redirect", 1, 2, HHY_EFFECT_NONE, false, false, false, false,
      "String, Map?", "WebResponse", "main"),
    C("web.response", 1, 1, HHY_EFFECT_NONE, false, false, false, false,
      "Map", "WebResponse", "main"),
    C("web.multipart", 1, 2, HHY_EFFECT_FILESYSTEM, false, true, false, false,
      "WebRequest, Path?", "Map", "main"),
    C("web.stream", 1, 2, HHY_EFFECT_NONE, true, true, false, false,
      "Stream<String | BytesBuffer>, Map?", "WebResponse", "main"),
    C("web.sse", 1, 1, HHY_EFFECT_NONE, true, true, false, false,
      "Stream<String>", "WebResponse", "main"),
    C("web.sign_cookie", 2, 2, HHY_EFFECT_NONE, false, false, false, false,
      "String, String", "String", "main"),
    C("web.verify_cookie", 2, 2, HHY_EFFECT_NONE, false, false, false, false,
      "String, String", "String | Null", "main"),
    C("web.metrics", 1, 2, HHY_EFFECT_NONE, false, false, false, false,
      "WebApp, String?", "WebApp", "main"),
    C("web.gzip", 1, 1, HHY_EFFECT_NONE, false, false, false, false,
      "WebApp", "WebApp", "main"),
    C("web.listen", 1, 2, HHY_EFFECT_NETWORK, false, true, false, true,
      "WebApp, Map?", "Null", "main"),
