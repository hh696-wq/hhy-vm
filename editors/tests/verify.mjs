...
assert.equal(extension.main, "./extension.cjs");
assert.equal(extension.activationEvents[0], "onLanguage:hhy");
assert.equal(extension.devDependencies["vscode-languageclient"], "9.0.1");
assert.equal(extension.devDependencies.esbuild, "0.25.9");
assert.equal(extension.devDependencies["@vscode/vsce"], "3.9.2");
assert.equal(extension.contributes.configuration.properties["hhy.executablePath"].default, "hhy");
