...
export default async function LearnIndex({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return (
    <LearnLayout language={lang}>
      ...
      <p className="docs-index-description">{lang === "zh" ? "学习 HHY v1.1.5 的进程扩展系统、可恢复 Spider，并直接使用官方数据库与 HTML 扩展。" : "Learn the HHY v1.1.5 process-extension system, resumable spider, and official database and HTML extensions."}</p>
      <div className="chapter-grid">
