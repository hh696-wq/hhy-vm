...
const groupLabel = {
  zh: { guide: "指南", project: "实战项目", reference: "参考", extension: "扩展", report: "语言报告", roadmap: "路线图", tooling: "工具" },
  en: { guide: "Guide", project: "Projects", reference: "Reference", extension: "Extensions", report: "Language Reports", roadmap: "Roadmap", tooling: "Tooling" }
} as const;
