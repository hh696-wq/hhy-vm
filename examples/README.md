...
> 当前版本：`1.4.3`；示例保持兼容 v1.0 冻结语义并持续运行 AST/Bytecode 双引擎及真实负载回归测试。
...
| `10-web-api.hhy` | 常驻 JSON API | Web Runtime、Router、JSON response |
...
hhy serve examples/10-web-api.hhy
```
